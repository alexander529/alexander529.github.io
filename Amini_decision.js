...
var questionNumber = true;

//first question
questionNumber = 1;
if(questionNumber === 1) {
    //bitmoji draw
drawBitmoji(93,244,54);
//intro text
fill(0, 0, 0); 
textSize(42);
text("Should I go Surfing?",11,50);
 textSize(26);
 text("Is the season good for surfing?",15,127);
 textSize(39);
 text("Yes",75,185);
 textSize(39);
 text("No",256,185);
...
mouseClicked = function () {
 if(mouseX<300 && mouseX>256 && mouseY<185 & mouseY>150)
 {
     stroke(15, 15, 15);
     fill(255, 255, 255);
      ellipse(330,270,125,90); 
   line(284,299,230,325);
    fill(0, 0, 0);
 textSize(17);
 
  text("dont go surfing",275,271);
 }
 else if(mouseX<150 && mouseX>75 && mouseY<200 && mouseY>165)
 {
     fill(255, 255, 255);
     rect(0,0,400,400);
...
text("Should I go Surfing?",11,50);
 textSize(26);
 text("Is the weather good for surfing?",15,127);
 textSize(39);
 text("Yes",75,185);
 textSize(39);
 text("No",256,185);
...
text("Should I go Surfing?",11,50);
 textSize(26);
 text("Is your board ready for surfing?",15,127);
 textSize(39);
 text("Yes",75,185);
 textSize(39);
 text("No",256,185);
...
text("Should I go Surfing?",11,50);
 textSize(26);
 text("Are the waves good for surfing?",15,127);
 textSize(39);
 text("Yes",75,185);
 textSize(39);
 text("No",256,185);
...
text("Should I go Surfing?",11,50);
 textSize(26);
 text("Is the beach open for surfing?",15,127);
 textSize(39);
 text("Yes",75,185);
 textSize(39);
 text("No",256,185);
